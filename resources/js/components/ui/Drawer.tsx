...
export function Drawer({ open, onClose, side = 'right', width = 480, children }: DrawerProps) {
    useEffect(() => {
        if (!open) return;
        ...
        >
            ...
            <div
                style={{
                    ...
                    animation: 'prizy-slide .2s cubic-bezier(.2,.8,.2,1)',
                    overflowY: 'auto',
                }}
            >
                {children}
