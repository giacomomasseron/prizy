...
beforeEach(() => {
    vi.stubGlobal('fetch', vi.fn(async (url: string, init?: RequestInit) => {
        ...
        if (url.includes('/v1/me')) return j({ data: { id: 'u1', workspace_id: 'w', name: 'A', email: 'a@x.co', admin_level: 'owner', is_developer: true, is_agent: false } });
        ...
        if (url.match(/\/issues\/i1$/)) return j({ data: { id: 'i1', title: 'T', description: '', status: 'todo', priority: 'medium', team_id: 't', project_id: null, cycle_id: null, assignee_id: null, created_by: 'u1', created_at: '2026-07-01T00:00:00.000000Z', updated_at: '2026-07-01T00:00:00.000000Z' } });
        return j({ data: [] });
    }));
});
