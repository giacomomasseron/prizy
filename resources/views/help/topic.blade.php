...
@section('content')
    <div class="wrap" style="padding:32px 0 64px">
        <a href="{{ \App\Services\HelpLocale::url('help.home', [], $lang) }}" class="faint" style="font-size:13px">‹ Help center</a>
                        ...
                        <ul style="list-style:none;margin:0;padding:0;display:flex;flex-direction:column;gap:10px">
                            @foreach ($section->published_articles as $article)
                                <li style="display:flex;justify-content:space-between;gap:12px">
                                    <a href="{{ \App\Services\HelpLocale::url('help.article', [$category->slug, $section->slug, $article->slug], $lang) }}">{{ $article->display_title }}</a>
