...
return new class extends Migration {
    public function up(): void
    {
        ...
        DB::statement('ALTER TABLE saved_views ENABLE ROW LEVEL SECURITY;');
        DB::statement('ALTER TABLE saved_views FORCE ROW LEVEL SECURITY;');
        DB::statement(
            "CREATE POLICY saved_views_workspace_isolation ON saved_views USING ("
    ...
    {
        DB::statement('DROP POLICY IF EXISTS saved_views_workspace_isolation ON saved_views;');
