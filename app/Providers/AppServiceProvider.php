...
use App\Policies\GithubIntegrationPolicy;
use App\Policies\SlackIntegrationPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(GithubIntegration::class, GithubIntegrationPolicy::class);
        Gate::policy(SavedView::class,        SavedViewPolicy::class);
        Gate::policy(SlackIntegration::class, SlackIntegrationPolicy::class);
